...
<head>
    ...
    <title>Modifica por teléfono</title>
    <!--JQUUERY-->
...
<body>
    ...
    <h1 style="text-align: center; color: #fff;">Modificación de contacto por el teléfono</h1>
    <div class="modal-dialog text-center">
        <div class="col-sm-8 principal">
            <div class="modal-content">
                <div class="col-12 imagen-user">
                </div>
                <form action="modifica_reg.php" method="POST" class="col-12">
